<template>
  <div id="app" class="bg-gray-200 min-h-screen antialiased">
    ...
    <section class="flex justify-between bg-gray-800 px-4 py-3">
      <div class="relative">
        <div class="absolute inset-y-0 left-0 flex items-center pl-3">
          <svg class="h-6 w-6 fill-current text-gray-600" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"><path d="M16.32 14.9l1.1 1.1c.4-.02.83.13 1.14.44l3 3a1.5 1.5 0 0 1-2.12 2.12l-3-3a1.5 1.5 0 0 1-.44-1.14l-1.1-1.1a8 8 0 1 1 1.41-1.41l.01-.01zM10 16a6 6 0 1 0 0-12 6 6 0 0 0 0 12z"/></svg>
        </div>
      <input class="bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-900 text-white rounded-lg pl-10 py-2 pr-4" type="text" placeholder="Search by keywords...">
      </div>
      <button class="inline-flex items-center bg-gray-700 hover:bg-gray-600 focus:outline-none rounded-lg shadow pr-4 pl-3 focus:shadow-outline">
    ...
    <main class="px-4 py-6">
      ...
      <div class="mt-4">
        <div>
          <div>
          <img class="rounded-lg shadow-md h-64" src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=60" alt="">
          </div>
          <div class="px-4 -mt-16 relative">
          <div class="bg-white rounded-lg px-4 py-3 shadow-lg">
            <div class="flex">
              <span class="bg-teal-200 text-teal-800 font-semibold px-2 py-1 inline-block rounded-full leading-none uppercase tracking-wide text-xs">Plus</span>
            ...
            <div class="mt-1">
             <span class="text-gray-900">$1,400</span><span class="text-gray-600 ml-1">/wk</span>
            </div>
